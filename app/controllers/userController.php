    ...
    public function actualizarFotoUsuarioControlador() {
        ...
        if($this-> actualizarDatos("usuario",$usuario_datos_up,$condicion)) {
            ...
            $alerta=[
                ...
                "texto"=>"La foto del usuario ".$datos['usuario_nombre']." se actualizo correctamente",
                "icono"=>"success"
            ];
        } else {
            ...
            $alerta=[
                "tipo"=>"recargar",
                "titulo"=>"Foto actualizada",
                "texto"=>"No hemos podido actualizar algunos datos del usuario ".$datos['usuario_nombre']." , sin embargo la foto ha sido actualizada",
                "icono"=>"warning"
            ];
        }
